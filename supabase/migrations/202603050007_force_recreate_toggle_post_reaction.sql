do $$ begin
  execute 'drop function if exists public.toggle_post_reaction(uuid, smallint)';
  execute 'drop function if exists public.toggle_post_reaction(uuid, integer)';
  execute 'drop function if exists public.toggle_post_reaction(uuid, bigint)';
  execute 'drop function if exists public.toggle_post_reaction(uuid, numeric)';
end $$;

create function public.toggle_post_reaction(p_post_id uuid, p_value smallint)
